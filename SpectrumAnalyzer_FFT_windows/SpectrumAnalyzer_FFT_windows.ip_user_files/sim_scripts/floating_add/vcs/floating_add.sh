...
#
# Generated by Vivado on Fri Nov 18 21:45:37 +0800 2022
...
# Script info
echo -e "floating_add.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../SpectrumAnalyzer_FFT_windows.srcs/sources_1/ip/floating_add/sim/floating_add.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_add xil_defaultlib.glbl -o floating_add_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating_add_simv $vcs_sim_opts -do simulate.do
}
