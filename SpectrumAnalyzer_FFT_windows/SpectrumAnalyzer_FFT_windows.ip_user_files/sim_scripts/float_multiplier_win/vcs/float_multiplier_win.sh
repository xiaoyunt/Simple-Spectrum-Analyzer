...
#
# Filename    : float_multiplier_win.sh
...
#
# Generated by Vivado on Sat Nov 19 09:41:09 +0800 2022
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: float_multiplier_win.sh [-help]
# usage: float_multiplier_win.sh [-lib_map_path]
# usage: float_multiplier_win.sh [-noclean_files]
# usage: float_multiplier_win.sh [-reset_run]
#
...
# executing this script. Please type 'float_multiplier_win.sh -help' for more information.
#
...
# Script info
echo -e "float_multiplier_win.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../SpectrumAnalyzer_FFT_windows.srcs/sources_1/ip/float_multiplier_win/sim/float_multiplier_win.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.float_multiplier_win xil_defaultlib.glbl -o float_multiplier_win_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./float_multiplier_win_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./float_multiplier_win.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key float_multiplier_win_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc float_multiplier_win_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./float_multiplier_win.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: float_multiplier_win.sh [-help]\n\
Usage: float_multiplier_win.sh [-lib_map_path]\n\
Usage: float_multiplier_win.sh [-reset_run]\n\
Usage: float_multiplier_win.sh [-noclean_files]\n\n\
