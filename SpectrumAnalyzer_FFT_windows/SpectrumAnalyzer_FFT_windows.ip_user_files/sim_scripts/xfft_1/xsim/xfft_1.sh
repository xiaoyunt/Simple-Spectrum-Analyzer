...
#
# Generated by Vivado on Wed Nov 16 15:47:32 +0800 2022
...
simulate()
{
  xsim xfft_1 -key {Behavioral:sim_1:Functional:xfft_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_68a3.protoinst" -protoinst "protoinst_files/bd_6e42.protoinst" -protoinst "protoinst_files/bd_36cd.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
