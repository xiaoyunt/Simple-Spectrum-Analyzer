...
#
# Generated by Vivado on Fri Nov 18 12:44:13 +0800 2022
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: fix_float_dds.sh [-help]
# usage: fix_float_dds.sh [-lib_map_path]
# usage: fix_float_dds.sh [-noclean_files]
# usage: fix_float_dds.sh [-reset_run]
#
...
# executing this script. Please type 'fix_float_dds.sh -help' for more information.
#
...
# Script info
echo -e "fix_float_dds.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../SpectrumAnalyzer_FFT_windows.srcs/sources_1/ip/fix_float_dds/sim/fix_float_dds.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fix_float_dds xil_defaultlib.glbl -o fix_float_dds_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fix_float_dds_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fix_float_dds.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fix_float_dds_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fix_float_dds_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fix_float_dds.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: fix_float_dds.sh [-help]\n\
Usage: fix_float_dds.sh [-lib_map_path]\n\
Usage: fix_float_dds.sh [-reset_run]\n\
Usage: fix_float_dds.sh [-noclean_files]\n\n\
