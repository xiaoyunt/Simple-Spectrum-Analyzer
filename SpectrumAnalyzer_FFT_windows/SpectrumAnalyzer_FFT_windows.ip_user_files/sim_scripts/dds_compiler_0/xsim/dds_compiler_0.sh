...
#
# Generated by Vivado on Wed Nov 16 18:58:03 +0800 2022
...
simulate()
{
  xsim dds_compiler_0 -key {Behavioral:sim_1:Functional:dds_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_68a3.protoinst" -protoinst "protoinst_files/bd_6e42.protoinst" -protoinst "protoinst_files/bd_36cd.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
