/* -------------------------------------------------------------------------------- */
/* -- 绀昒I - Generic GUI module (C)Achim D榀緇er, 2015                            -- */
/* -------------------------------------------------------------------------------- */
// 绀昒I is a generic GUI module for embedded systems.
// This is a free software that is open for education, research and commercial
// developments under license policy of following terms.
//
//  Copyright (C) 2015, Achim D榀緇er, all rights reserved.
//  URL: http://www.embeddedlightning.com/
//
// * The 绀昒I module is a free software and there is NO WARRANTY.
...
//quarter circle  -2022.9.25
// quadrant: 1~4; 0 : fill circle
...
//back: if 1: it has background, 0 : none
void UG_PutString( UG_S16 x, UG_S16 y, char* str ,UG_S8 back)
{
   ...
   while ( *str != 0 )
   {
      ...
      UG_PutChar(chr, xp, yp, gui->fore_color, gui->back_color ,back);
...
void UG_ConsolePutString( char* str )
{
   ...
   while ( *str != 0 )
   {
      ...
      UG_PutChar(chr, gui->console.x_pos, gui->console.y_pos, gui->console.fore_color, gui->console.back_color,0);
      str++;
   }
}
...
void _UG_PutText(UG_TEXT* txt)
{
   ...
   while( 1 )
   {
      ...
      while( (*str != '\n') )
      {
         ...
         switch ( bt )
         {
            case 0xF6: bt = 0x94; break; // 锟�
            case 0xD6: bt = 0x99; break; // 锟�
            case 0xFC: bt = 0x81; break; // 锟�
            case 0xDC: bt = 0x9A; break; // 锟�
            case 0xE4: bt = 0x84; break; // 锟�
            case 0xC4: bt = 0x8E; break; // 锟�
            case 0xB5: bt = 0xE6; break; // 锟�
            case 0xB0: bt = 0xF8; break; // 锟�
         }
         yo = yp;
         bn = char_width;
         bn >>= 3;
