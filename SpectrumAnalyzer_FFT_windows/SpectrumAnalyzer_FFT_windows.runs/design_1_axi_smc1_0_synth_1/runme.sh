...
HD_PWD='L:/PersonalProjects/Xilinx/SpectrumAnalyzer4/SpectrumAnalyzer4.runs/design_1_axi_smc1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_smc1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_smc1_0.tcl
