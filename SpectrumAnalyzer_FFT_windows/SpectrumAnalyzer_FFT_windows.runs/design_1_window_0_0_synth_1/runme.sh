...
HD_PWD='L:/PersonalProjects/Xilinx/SpectrumAnalyzer_FFT_windows/SpectrumAnalyzer_FFT_windows.runs/design_1_window_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_window_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_window_0_0.tcl
