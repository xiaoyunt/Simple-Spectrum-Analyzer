...
HD_PWD='L:/PersonalProjects/Xilinx/SpectrumAnalyzer_FFT_windows/SpectrumAnalyzer_FFT_windows.runs/fix_float_dds_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fix_float_dds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fix_float_dds.tcl
